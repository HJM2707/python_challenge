...
import csv
# Set path for file
filepath = os.path.join('c:/Users/61469/MONU-VIRT-DATA-PT-10-2022-U-LOLC/02-Homework/03-Python/Instructions/python_challenge/PyBank_1/resources1/budget_data.csv')
...
# Set path for file
filepath = os.path.join('c:/Users/61469/MONU-VIRT-DATA-PT-10-2022-U-LOLC/02-Homework/03-Python/Instructions/python_challenge/PyBank_1/resources1/PyBank_Results.txt')
