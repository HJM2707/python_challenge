...
filepath = os.path.join(r'C:\Users\61469\MONU-VIRT-DATA-PT-10-2022-U-LOLC\02-Homework\03-Python\Instructions\python_challenge\Pypoll_1\resources2\election_data.csv')
...
# Set path for file
filepath = os.path.join(r'C:\Users\61469\MONU-VIRT-DATA-PT-10-2022-U-LOLC\02-Homework\03-Python\Instructions\python_challenge\Pypoll_1\resources2\PyPoll_Results.txt')
